...
class PdoGsb
{
	...
	{
		$req = "select visiteur.id as id, visiteur.nom as nom, visiteur.prenom as prenom, role.libelle as role from visiteur, role 
		where visiteur.idRole = role.idRole and visiteur.login='$login' and visiteur.mdp='$mdp'";
